<table>
    ...
    <tr>
        ...
        <th colspan="7" style="text-align:center; background-color:#63b8d5; border-left: 1px solid #ccc; border-right: 1px solid #000000;"><b>{{ $lang['_total_service_cost'] }}</b></th>
    </tr>
    </thead>
    <tbody>
    ...
    @foreach($services as $service)
        <tr >
            ...
            <td colspan="7" style="text-align:center; background-color:#63b8d5; border-left: 1px solid #000000; border-right: 1px solid red;"><b>-{{ $service['total_service_cost'] }}</b></td>
        </tr>
        ...
        <tr >
          ...
          @foreach($service['bydates'] as $bydate)
           ...
           <tr>
                <td colspan="11" style="text-align:center; background-color:#d5d0b5">{{ $bydate['sdate'] }}</td>
           </tr>
