...
class ServiceProcedure extends Model
{
    ...
    protected $fillable = ['service_id', 'name', 'preposition', 'step', 'action_id', 'category_id', 'is_required', 'required_service_procedure', 'status_upon_completion', 'documents_mode', 'documents_to_display', 'is_suggested_count'];
